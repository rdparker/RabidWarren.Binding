...
//  </copyright>
//  <summary>
//   Defines an extended interface for objects that implement INotifyPropertyChange.
//  </summary>
// ----------------------------------------------------------------------------------------------------------------
namespace RabidWarren.Binding
{
    ...
    public interface INotifyingObject : INotifyPropertyChanged
    {
        ...
        [SuppressMessage("ReSharper", "UnusedMemberInSuper.Global",
            Justification =
                "This Is not explicitly used within RabidWarren.Binding, but must be implemented because there are " +
                "times in user code when it must be raised using a string name.")]
