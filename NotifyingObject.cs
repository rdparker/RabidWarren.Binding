...
//  </copyright>
//  <summary>
//   Provides the base implementation for raising the PropertyChanged event.
//  </summary>
// ----------------------------------------------------------------------------------------------------------------
...
namespace RabidWarren.Binding
{
    ...
    /// <summary>
    ///     Provides the base implementation for raising the PropertyChanged event on objects which have properties
    ///     that act as binding sources.
    /// </summary>
